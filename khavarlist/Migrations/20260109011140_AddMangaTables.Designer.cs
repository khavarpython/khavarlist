...
namespace khavarlist.Migrations
{
    ...
    [Migration("20260109011140_AddMangaTables")]
    partial class AddMangaTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("khavarlist.Areas.Identity.Data.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("khavarlist.Areas.Identity.Data.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("khavarlist.Models.UserAnime", b =>
                {
                    b.HasOne("khavarlist.Models.Anime", "Anime")
                        .WithMany()
